...
$gnavi_key = '2e295c9b9c640e2c4398d546c59f74c4';
$freeword = $_GET['freeword'];

$response = file_get_contents(
	'http://api.gnavi.co.jp/ver1/RestSearchAPI/?keyid='.$gnavi_key
	.'&area=AREA160&pref=PREF03&sort=1&address=岩手県盛岡市&freeword='.$freeword);

echo json_encode(xmlToArray(simplexml_load_string($response)));
